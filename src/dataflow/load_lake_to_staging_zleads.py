...
class Runner():
    ...
    def run(cls):
        ...
        log.warning('>> Running Lake to Staging zleads pipeline')
...
if __name__ == '__main__':
    ...
    logging.getLogger().warning('> load_lake_to_staging_zleads - Starting DataFlow Pipeline Runner')
    Runner().run()
